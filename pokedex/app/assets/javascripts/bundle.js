...
document.addEventListener("DOMContentLoaded", function () {
  ...
  window.catchAllPokemons = _api_util.catchAllPokemons;
  window.receiveAllPokemons = _pokemon_actions.receiveAllPokemons;
...
var catchAllPokemons = exports.catchAllPokemons = function catchAllPokemons() {
  return $.ajax({
    method: 'GET',
    url: 'api/pokemon'
  });
...
var catchSinglePokemon = exports.catchSinglePokemon = function catchSinglePokemon(id) {
  return $.ajax({
    method: 'GET',
    url: 'api/pokemon/' + id
  });
...
exports.requestAllPokemon = exports.receiveAllPokemons = exports.CATCH_SINGLE_POKEMON = exports.CATCH_ALL_POKEMONS = undefined;
...
var CATCH_ALL_POKEMONS = exports.CATCH_ALL_POKEMONS = 'CATCH_ALL_POKEMONS';
var CATCH_SINGLE_POKEMON = exports.CATCH_SINGLE_POKEMON = 'CATCH_SINGLE_POKEMON';

var receiveAllPokemons = exports.receiveAllPokemons = function receiveAllPokemons(pokemon) {
  return {
...
var requestAllPokemon = exports.requestAllPokemon = function requestAllPokemon() {
  return function (dispatch) {
    return APIUtil.catchAllPokemons().then(function (pokemon) {
      return dispatch(receiveAllPokemons(pokemon));
    });
  };
};
...
var pokemonReducer = function pokemonReducer() {
  ...
  switch (action.type) {
    case _pokemon_actions.CATCH_ALL_POKEMONS:
      return action.pokemon;
    case _pokemon_actions.CATCH_SINGLE_POKEMON:
      return action.pokemon;
    default:
      return state;
  }
